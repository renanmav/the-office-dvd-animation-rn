...
const DfromDisc =
  "M99.424,67.329C47.281,67.329,5,73.449,5,81.012c0,7.558,42.281,13.678,94.424,13.678c52.239,0,94.524-6.12,94.524-13.678C193.949,73.449,151.664,67.329,99.424,67.329z M96.078,85.873c-11.98,0-21.58-2.072-21.58-4.595c0-2.523,9.599-4.59,21.58-4.59c11.888,0,21.498,2.066,21.498,4.59C117.576,83.801,107.966,85.873,96.078,85.873z";

const DEFAULT_SIZE = 150;

type DVDLogoProps = SvgProps & {
  r: number;
  g: number;
  b: number;
};

export const DVDLogo = (props: DVDLogoProps) => {
  const { width = DEFAULT_SIZE, height = DEFAULT_SIZE } = props;

  const fill = `rgb(${props.r}, ${props.g}, ${props.b})`;

  return (
    <View style={{ width, height }}>
      <Svg height="100%" width="100%" viewBox="0 0 210 107" {...props}>
        <Path fill={fill} d={DfromDVD} />
        <Path fill={fill} d={DfromDisc} />
      </Svg>
    </View>
  );
};
